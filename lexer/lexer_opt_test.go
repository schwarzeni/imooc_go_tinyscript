...
// 		wantResult []*Token
// 	}{
// 		{name: "test1", args: args{it: common.NewPeekIterator(strings.NewReader("var false   abc23b + true / function 23"))}, wantErr: false, wantResult: []*Token{
// 			NewToken(KEYWORD, "var"),
// 			NewToken(BOOLEAN, "false"),
// 			NewToken(VARIABLE, "abc23b"),
// 			NewToken(VARIABLE, "+"),
// 			NewToken(BOOLEAN, "true"),
// 			NewToken(VARIABLE, "-"),
// 			NewToken(KEYWORD, "function"),
// 		}},
// 	}
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			for _, t := range tt.wantResult {
// 				got, err := MakeVarOrKeyword(tt.args.it)
// 			}
// 		})
// 	}
